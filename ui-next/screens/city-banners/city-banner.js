...
var
  ...
  _tmpl$16 = template(`<div class="flex-auto -mr-3 flex flex-col"><div class="city-banner__conquered-icon relative size-14 -mr-6 bg-cover bg-no-repeat flex"></div></div>`),
