...
var
  ...
  _tmpl$3 = /* @__PURE__ */ template(`<div class="city-banner__original-capital-curr-star w-6 h-6 bg-cover bg-no-repeat pointer-events-auto"></div>`),
  _tmpl$4 = /* @__PURE__ */ template(`<div class="city-banner__capital-star w-6 h-6 bg-cover bg-no-repeat pointer-events-auto"></div>`),
  _tmpl$5 = /* @__PURE__ */ template(`<div class="city-banner__original-capital-star w-6 h-6 bg-cover bg-no-repeat pointer-events-auto city-banner__town-original-capital-star"></div>`),
  _tmpl$6 = /* @__PURE__ */ template(`<p class="city-banner__name font-title text-base uppercase"></p>`),
  _tmpl$7 = /* @__PURE__ */ template(`<div class="city-banner__status flex justify-center align-center opacity-100 pointer-events-auto"><div class="city-banner__status-background h-full w-full absolute"></div><div class="city-banner__status-icon absolute w-full h-full bg-no-repeat"></div></div>`),
  _tmpl$8 = /* @__PURE__ */ template(`<div class="city-banner__religion-symbol-bg pointer-events-auto"></div>`),
  _tmpl$9 = /* @__PURE__ */ template(`<div class="city-banner__religion-symbol-bg pointer-events-auto religion-bg--right"></div>`),
  _tmpl$10 = /* @__PURE__ */ template(`<div class="city-banner__religion self-center relative flex flex-row"></div>`),
  _tmpl$11 = /* @__PURE__ */ template(`<div class="city-banner__trade-network flex justify-center align-center pointer-events-auto"><div class="city-banner__trade-network-background h-full w-full absolute"></div><div class="city-banner__trade-network-icon absolute w-full h-full bg-no-repeat"></div></div>`),
  _tmpl$12 = /* @__PURE__ */ template(`<div class="city-banner__production-container city-banner__queue-container queue-production items-center justify-center w-8 h-6 -mt-2"><div class="city-banner__production"></div></div>`),
  _tmpl$13 = /* @__PURE__ */ template(`<div class="city-banner__city-state-icon size-8 self-center align-center bg-cover bg-no-repeat"></div>`),
  _tmpl$14 = /* @__PURE__ */ template(`<div class="city-banner__city-state-container justify-center"><div class="city-banner__city-state-type size-7 self-center align-center justify-center flex"></div></div>`),
  ...
  _tmpl$16 = /* @__PURE__ */ template(`<div class="flex-auto -mr-3 flex flex-col"><div class="city-banner__conquered-icon relative size-14 -mr-6 bg-cover bg-no-repeat flex"></div></div>`),
  ...
  _tmpl$19 = /* @__PURE__ */ template(`<div class="items-center -ml-12 mt-10 city-banner__right-container flex flex-row"></div>`);
